...
function Task({title, completed, total, stats}: StatsRingCardProps) {
...
export default function  tasks(){
    return(
      <Task title={"Finish this website"} completed={5} total={100} stats={[{value:100, label:'Ongoing'}]} key={"Finish this website"} ></Task>
    );
}